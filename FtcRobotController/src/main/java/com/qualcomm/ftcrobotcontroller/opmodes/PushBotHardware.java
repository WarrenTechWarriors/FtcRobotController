...

{
...

    {
        ...
        // Connect the servo motors.
        //
        // Indicate the initial position of the servo. The swivel
        // should be in the middle position.
        //
        double l_swivel_position = 0.5;

        try
        {
            v_servo_swivel = hardwareMap.servo.get ("swivel");
            v_servo_swivel.setPosition (l_swivel_position);
        }
        catch (Exception p_exeception)
        {
            m_warning_message ("swivel");
            DbgLog.msg (p_exeception.getLocalizedMessage ());
    ...
    //
    /**
     * Access the swivel position.
     */
    double a_swivel_position ()
    {
        double l_return = 0.0;

        if (v_servo_swivel != null)
        {
            l_return = v_servo_swivel.getPosition ();
        }
    ...
    //
    /**
     * Mutate the swivel position.
     */
    void m_swivel_position (double p_position)
    {
        //
        // Ensure the specific value is legal.
        //
        ...
        if (v_servo_swivel != null)
        {
            v_servo_swivel.setPosition (l_position);
        }
    ...
    //
    /**
     * Manage the aspects of the swivel servo.
     */
    private Servo v_servo_swivel;
